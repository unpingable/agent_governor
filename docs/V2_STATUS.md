...
As of 2.8.1. This document is the boundary between "shipped" and "next."
...
|------|---------|----------|
| [agent_gov](https://github.com/unpingable/agent_governor) | 2.8.1 | — |
...
```bash
governor --version                      # should say 2.8.1
