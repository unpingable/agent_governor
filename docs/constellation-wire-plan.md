...
| Night Shift | `~/git/nightshift` (moved from `~/git/scheduler`, 2026-07-05) | NS→AG translation (`nightshift_adapter.py`): frozen verdict mapping into `policy_engine` | translation stub; NS calls AG, never back | n.a. | W2 — nightshift live dogfood (the first natural one) |
