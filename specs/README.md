...
- **Specs 14–16, 21** are gap specs — features that don't exist yet but are designed.
- **Specs 17–20** are now implemented (External Constraint, MCP Safety, SDK Middleware, Session Continuity).
